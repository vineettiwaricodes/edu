                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Colleges</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">All Colleges</a></li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div id="list-view" class="tab-pane fade active show col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">All Colleges List </h4>
                                        <a href="add-colleges.php" class="btn btn-primary">+ Add new</a>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table id="example3" class="display" style="min-width: 845px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>2011/04/25</td>
                                                        <td>
                                                            <a href="edit-college.php" class="btn btn-sm btn-primary"><i
