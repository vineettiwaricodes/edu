...
if(jQuery('#pie_chart').length > 0 ){
    ...
    new Chart(pie_chart, {
        ...
        data: {
            ...
            labels: [
                "Unknown-Shri Venkateshwara University",
                "MBA-Shri Venkateshwara University",
                "MCA-Shri Venkateshwara University", 
                "M.com-Shri Venkateshwara University",
                "M.ed-Shri Venkateshwara University"
            ]
        },
        options: {
            responsive: true, 
