...
<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="all-leads.php" aria-expanded="false">
                    <i class="la la-users"></i>
                    <span class="nav-text">All Leads</span>
                </a>
                
            </li>
            <li><a class="has-arrow" href="failed-leads.php" aria-expanded="false">
                    <i class="la la-graduation-cap"></i>
                    <span class="nav-text">Failed Leads</span>
                </a>
                
            </li>
            <li><a class="has-arrow" href="my-followups.php" aria-expanded="false">
                    <i class="la la-book"></i>
                    <span class="nav-text">My Follow-Ups</span>
                </a>
            </li>
            <li><a class="has-arrow" href="payment status.php" aria-expanded="false">
                    <i class="la la-book"></i>
            ...
            <li><a class="has-arrow ai-icon" href="top-brands.php" aria-expanded="false">
            <i class="la la-globe"></i>
                    <span class="nav-text">Top Brands</span>
                </a>
               
            </li>
            <li><a class="has-arrow" href="enquiry.php" aria-expanded="false">
                    <i class="la la-graduation-cap"></i>
            ...
            <!-- <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="all-library.php">All Library</a></li>
                    <li><a href="add-library.php">Add Library</a></li>
                    <li><a href="edit-library.php">Edit Library</a></li>
                </ul>
            </li>
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    <i class="la la-building"></i>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="edit-departments.php">Edit Departments</a></li>
                </ul>
            </li>
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    <i class="la la-users"></i>
            ...
            <li><a href="widget-basic.php" aria-expanded="false">
